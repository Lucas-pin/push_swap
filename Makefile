...
#    Updated: 2024/10/17 19:52:40 by lpin             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = src/push_swap.c src/orchestor.c src/check_entry.c src/check_list.c src/errors.c \
		src/linked_list_utils.c src/ft_ps_destroy.c src/ps_utils.c src/list_init.c \
		src/ft_swap.c src/sw_moves.c src/ft_rotate.c src/rt_moves.c src/ft_reverse_rotate.c \
		src/rrt_moves.c src/ft_push.c src/ps_moves.c src/ft_metadata.c
LIBFT = ./libft/libft.a
OBJS = $(SRCS:.c=.o)
